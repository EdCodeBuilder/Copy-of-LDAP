...
class ProgramController extends Controller
{
    ...
    {
        parent::__construct();
        $this->middleware(Roles::actions(Program::class, 'create'))
            ->only('store');
        $this->middleware(Roles::actions(Program::class, 'update'))
            ->only('update');
        $this->middleware(Roles::actions(Program::class, 'destroy'))
            ->only('destroy');
    }
